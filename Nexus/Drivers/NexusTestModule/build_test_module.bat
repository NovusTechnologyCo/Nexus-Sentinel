...
setlocal
REM ============================================================================================
REM Build NexusTestModule.sys -- the conforming module used to exercise map/unmap end to end.
REM
...
echo === Building NexusTestModule ===
msbuild "%ROOT%\Nexus\Drivers\NexusTestModule\NexusTestModule.vcxproj" /p:Configuration=Release /p:Platform=x64 /v:minimal /nologo
if errorlevel 1 ( echo ERROR: build failed & exit /b 1 )

echo.
echo === TEST MODULE OK ===
echo   %ROOT%\Nexus\Drivers\NexusTestModule\bin\NexusTestModule.sys
endlocal
